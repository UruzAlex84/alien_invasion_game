...
class Scoreboard():
	...
	def __init__(self, ai_settings, screen, stats):
		...
		self.prep_score()
		#Подготовка изображения рекорда
		self.prep_high_score()
		#Подготовка изображения текущего уровня
		self.prep_level()
		#Подготовка изображений количества кораблей (жизней)
		self.prep_ships()
	...
	def prep_level(self):
		"""Преобразует число текущего уровня в графическое представление"""
